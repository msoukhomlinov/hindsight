...
ENV_RERANKER_TYPESAFE_DROP_IRRELEVANT = "HINDSIGHT_API_RERANKER_TYPESAFE_DROP_IRRELEVANT"
...
# 73%. Batching is therefore a ranking-only economy, unsafe with drop_irrelevant.
...
DEFAULT_RERANKER_TYPESAFE_DROP_IRRELEVANT = False
    ...
    while True:
        ...
        members.append(
            RerankerMemberConfig(
                ...
                typesafe_drop_irrelevant=_member_bool(
                    base, "TYPESAFE_DROP_IRRELEVANT", DEFAULT_RERANKER_TYPESAFE_DROP_IRRELEVANT
                ),
...
class HindsightConfig:
    ...
    reranker_typesafe_drop_irrelevant: bool
    ...
    def reranker_chain(self) -> list[RerankerMemberConfig]:
        ...
        primary = RerankerMemberConfig(
            ...
            typesafe_drop_irrelevant=self.reranker_typesafe_drop_irrelevant,
    ...
    def from_env(cls) -> "HindsightConfig":
        ...
        config = cls(
            ...
            reranker_typesafe_drop_irrelevant=_parse_boolean_env(
                ENV_RERANKER_TYPESAFE_DROP_IRRELEVANT, DEFAULT_RERANKER_TYPESAFE_DROP_IRRELEVANT
            ),
