...
| `hindsightApiKeyRef` | —                                    | Paperclip secret **ID** (UUID, from Secrets → copy ID) holding your Hindsight API key, or the literal key itself for self-hosted setups with no bound secret          |
